"""
Django settings for round_cake_41182 project.
...
ROOT_URLCONF = 'round_cake_41182.urls'
...
WSGI_APPLICATION = 'round_cake_41182.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_cake_41182 API",
    "DESCRIPTION": "API documentation for round_cake_41182 App",
    "VERSION": "v1",
}
